export const siteConfig = {
  ...
  aboutMe:
    "IT 미디어 공학을 전공하며 4.2/4.5의 성적을 유지하고 있습니다. 독일 마르부르크 대학교에서 XAI(설명 가능한 AI) 개인 연구를 수행하며 기술적 깊이를 쌓았으며, 세 번의 인턴십을 통해 AI 자동화 파이프라인 구축 역량을 증명했습니다. '기술은 만국 공통어'라는 신념으로 다양한 이해관계자와 소통하며 문제를 해결하는 엔지니어입니다.",
